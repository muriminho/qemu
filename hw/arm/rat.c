...
#define TYPE_VEXPRESS_MACHINE   "rat"
#define TYPE_VEXPRESS_A9_MACHINE   MACHINE_TYPE_NAME("rat-a9")
#define TYPE_VEXPRESS_A15_MACHINE   MACHINE_TYPE_NAME("rat-a15")
                                  ...
                                  qemu_irq *pic)
{
    ...
    if (ram_size > 0x40000000) {
        ...
        error_report("rat-a9: cannot model more than 1GB RAM");
        exit(1);
    }
                                   ...
                                   qemu_irq *pic)
{
...

    {
        ...
        if (rsz > (30ULL * 1024 * 1024 * 1024)) {
            error_report("rat-a15: cannot model more than 30GB RAM");
            exit(1);
        }
    }
...
static void vexpress_a15_instance_init(Object *obj)
{
    ...
    /*
     * For the rat-a15, EL2 is by default enabled if EL3 is,
